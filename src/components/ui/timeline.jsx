      ...
      <div className='header'>
        <div className="container">
          ...
          <section className="social">
            <a target="_blank" className="btn-t" rel="noopener noreferrer" href="https://www.github.com/itbruno">youtube</a>
            <a target="_blank" className="btn-t" rel="noopener noreferrer" href="https://www.twitter.com/_brunoweb">Twitter</a>
          </section>
        </div>
      </div>

      <div className="container">
        <h1 className="project-name text-xl font-serif">MEMBERSHIP DETAIL'S</h1>
        <div id="timeline">
          <div className="timeline-item">
            <div className="timeline-icon">
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="21px" height="20px" viewBox="0 0 21 20" enableBackground="new 0 0 21 20" xmlSpace="preserve">
